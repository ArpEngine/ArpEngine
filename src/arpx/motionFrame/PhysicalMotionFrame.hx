...
class PhysicalMotionFrame extends MotionFrame {
	...
	override public function updateShadowPosition(shadow:Mortal, oldTime:Float, newTime:Float):Void {
	...
	override public function updateMortalPosition(field:Field, mortal:Mortal, oldTime:Float, newTime:Float, dHitType:String):Void {
		var factor:Float = newTime - oldTime;
